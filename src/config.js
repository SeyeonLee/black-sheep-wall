...
export const CONFIG = {
  ...
  // Turret (fast-attack gunboat)
  TURRET_SPEED: 0.9,
  TURRET_FIRE_RANGE: 50,
  TURRET_DAMAGE_PER_TICK: 3,
  TURRET_AMMO: 500,
  TURRET_FIRE_RATE: 2,           // rounds consumed per dt
  TURRET_BATTERY_DRAIN: 0.01,
  TURRET_SOLAR_RATE: 0.04,
  TURRET_LOW_BATTERY: 40,
  TURRET_SENSOR_RANGE: 160,

  // Default health per unit type (how many damage-points before death)
  HEALTH_USV: 30,
  HEALTH_TURRET: 50,
  HEALTH_ENEMY: 2000,
  HEALTH_COMMERCIAL: 500,
  HEALTH_SUBMARINE: 4000,
  HEALTH_MINE: 5,
